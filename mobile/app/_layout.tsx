...
function AuthGate() {
  ...
  useEffect(() => {
    ...
    const inNamedRoute = segments[0] === 'game' || segments[0] === 'user' || segments[0] === 'admin' || segments[0] === 'picks-by-team' || segments[0] === 'team' || segments[0] === 'team-central' || segments[0] === 'rules' || segments[0] === 'settings';
    if (!user && !inAuthGroup) {
